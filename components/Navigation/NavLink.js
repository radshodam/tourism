  ...
  return (
    <a
      ...
      className={classNames(
        current ? "bg-white bg-opacity-10 font-semibold" : "hover:bg-white hover:bg-opacity-20",
    ...
    >
      ...
      {name}
      {name === "Comments" && (
        <p className="bg-red-500 ml-auto mr-2 font-extralight text-center flex justify-center items-center rounded-full w-5 h-5">
          3
        </p>
      )}
    </a>
